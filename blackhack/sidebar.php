	...
	<br clear="all"/><!--下面的块clear both无法生效，故增加前面的语句 -->
		...
		<div id="weibo">
			...
			if($can_hits_real >= 1){
				...
				echo "<table><tr><td  colspan='2'>剩余请求次数：".$can_hits_real."</td></tr><tr><td>Remaining Ip Hits</td><td>Remaining User Hits</td></tr><tr><td><div id='re_ip_hit' style='width:". $ip_width."px;'>".$limit['remaining_ip_hits']."</div></td><td><div id='re_user_hit' style='width:".$user_width."px;'>".$limit['remaining_user_hits']."</div></td></tr></table>";
